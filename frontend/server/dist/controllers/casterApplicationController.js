...
export const createApplication = async (req, res, next) => {
    try {
        const { type, name, email, country, experience, specialty, description, twitchUsername, youtubeChannel, portfolio, motivation } = req.body;
...
//# sourceMappingURL=casterApplicationController.js.map
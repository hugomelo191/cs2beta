...
class LiveUpdateService {
     ...
     */
    async checkRegisteredTeamsMatches() {
        try {
            ...
            if (filteredMatches.length > 0) {
                ...
                for (const matchResult of filteredMatches) {
                    const matchUpdate = {
                        ...
                        current_score: matchResult.match.current_score || { faction1: 0, faction2: 0 },
                        map: matchResult.match.map || 'TBD',
                        status: 'ONGOING',
     ...
     */
    broadcastLiveMatchUpdate(matchData) {
        const io = global.io;
        if (io) {
            const update = {
     ...
     */
    broadcastPlayerUpdate(playerId, playerData) {
        const io = global.io;
        if (io) {
            const update = {
                type: 'PLAYER_UPDATE',
     ...
     */
    broadcastRegisteredTeamUpdate(teamId, teamData) {
        const io = global.io;
        if (io) {
            const update = {
     ...
     */
    broadcastTeamUpdate(teamId, teamData) {
        const io = global.io;
        if (io) {
            const update = {
                type: 'TEAM_UPDATE',
     ...
     */
    broadcastNewTeamRegistration(teamData) {
        const io = global.io;
        if (io) {
            const update = {
...
//# sourceMappingURL=liveUpdateService.js.map
...
// @access  Public
export const getCasters = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    if (search) {
      whereConditions.push(
        or(
          like(casters.name, `%${search}%`),
          like(casters.specialty, `%${search}%`),
          like(casters.bio, `%${search}%`)
        )
      );
    }
...
// @access  Public
export const getCaster = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
// @access  Private
export const createCaster = async (req: Request, res: Response, next: NextFunction) => {
  try {
    // Validate input
...
// @access  Private
export const updateCaster = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
// @access  Private
export const deleteCaster = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
// @access  Public
export const getLiveCasters = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const limit = parseInt(req.query.limit as string) || 10;

    const liveCasters = await db.query.casters.findMany({
      where: and(
        eq(casters.isLive, true),
        sql`${casters.currentGame} IS NOT NULL`
      ),
...
// @access  Public
export const getCastersByType = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
// @access  Public
export const getTopRatedCasters = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const limit = parseInt(req.query.limit as string) || 10;

    const topRatedCasters = await db.query.casters.findMany({
      where: and(
        sql`${casters.rating} > 0`,
        sql`${casters.totalRatings} >= 5`
      ),
...
// @access  Private
export const updateLiveStatus = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
// @access  Private
export const rateCaster = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params;
...
// @access  Public
export const getCastersByCountry = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
// @access  Public
export const getCastersBySpecialty = async (req: Request, res: Response, next: NextFunction) => {
  try {
